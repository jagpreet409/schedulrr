...
import {startOfDay,addDays,parseISO,format, isBefore, addMinutes} from "date-fns";
...
export async function createEvent(data) {
  ...
  const event = await db.event.create({
    data: {
      ...validatedData,
      userId: user.id, //unique to our database
    },
  });
...
//to delete event and it will for auth and inside db . after this
...
function generateAvailableSlots(startTime, endTime, duration, bookings, dateStr, timeGap =0){
